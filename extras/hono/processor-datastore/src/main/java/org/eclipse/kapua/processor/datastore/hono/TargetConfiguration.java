...
public class TargetConfiguration {
    ...
    public TargetConfiguration() {
        destination = HonoDatastoreSettings.getInstance().getString(HonoDatastoreSettingsKey.ERROR_DESTINATION);
        prefetchMessages = HonoDatastoreSettings.getInstance().getInt(HonoDatastoreSettingsKey.ERROR_PREFETCH_MESSAGES);
        clientId = HonoDatastoreSettings.getInstance().getString(HonoDatastoreSettingsKey.ERROR_CLIENT_ID);
